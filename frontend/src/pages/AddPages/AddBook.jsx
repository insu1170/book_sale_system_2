...
export const AddBook = () => {
    ...
    const addBookInfo = async () => { // insert
        const sends = await userPostApi('insert', `book`, [`bookId`, `name`, `price`, `quantity`, `bookUrl`], [inputValue.bookId, inputValue.name, inputValue.price, inputValue.quantity, inputValue.imgUrl])
        console.log(sends)
    }
    ...
    return (
        ...
        <AddContainer>
            ...
            <StyledButton onClick={addBookInfo}>등록하기</StyledButton>
        </AddContainer>)
}